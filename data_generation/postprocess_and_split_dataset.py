"""Postprocess CALPHAD outputs and split dataset by temperature.

Utilities used to compute A2/B2 aggregated outputs and to split the
dataset by temperature groups for training / testing.
"""
...
def main():
    ...
    df = pd.read_hdf("dataset_b.h5", key='df')
