...
This repository contain datasets and scripts to reproduce selected datasets and results of the study.

TODO: Add citation information.

Description of the files (you can run the scripts in this order to create datasets B_dev and B_test)
composition_pool_generator.py
- Generates the compositions (inputs in Dataset B)
calphad_data_generator.py
- Runs CALPHAD calculations for given composition set in multiple temperatuers (outputs for Dataset B) using asynchronous parallel processing.
...
Requirements.txt is included to install the required Python packages, excluding tc-python which you can install after installing Thermo-Calc.
1. Install Thermo-Calc (tested using version 2025b)
2. Install the Python (3.9.17) packages from requirements.txt
3. Install tc_python (tc-python==2025.2.30, using Python wheel file provided with Thermo-Calc 2025b)
